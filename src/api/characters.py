    ...
    * `number_of_lines_together`: The number of lines the character has with the
    ...
    stmt2 = (
        ...
        .select_from(
            ...
            .join(sa.select([db.conversations.c.conversation_id]).where((db.conversations.c.character1_id == id or db.conversations.c.character2_id == id) and db.conversations.c.movie_id == db.characters.c.movie_id).alias("conv"), db.conversations.c.conversation_id == sa.column("conv.conversation_id"))
